...
> **Note:** all candidate-specific files live in [`candidate/`](candidate/README.md) —
> edit them with your real data after cloning. The repo ships with working
> example data; a friend can clone, edit `candidate/`, and run. Optional
> integrations (Google Sheets mirror, Drive upload, Gmail alerts) each need
> a one-time OAuth setup described in CLAUDE.md.
