...
docs/MARKET_MEMORY_PLAN.md  Keep what the hunt SEES, not only what it applies to (draft,
                            ...
                            SKIP rows, `source` written not guessed, `/market` digest and
                            default-OFF search rules. The X side of #276's `outcome_label`.
