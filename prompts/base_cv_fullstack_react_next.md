# Base CV — Full-Stack Track (React + Next.js / Node.js)

Pre-optimized React/Next.js full-stack bullets and skills for use as a generation baseline.
...
## Skills (React/Next.js full-stack ordered — reorder by job relevance, add missing from posting)

**frontend**: JavaScript, TypeScript, React, Next.js, Node.js, Angular (background), RxJS, AG Grid, HTML, SCSS, Bootstrap
**backend**: Node.js, NestJS (familiar), REST API, WebSockets (SignalR)
...
**bullets**:
- Refactored 20+ heterogeneous LLM evaluation report pages into 2 reusable TypeScript/JavaScript templates with configurable Node.js-backed data pipelines — enabled ~10 new composable reports without per-report rework.
...
**bullets**:
- Built 2 full-stack TypeScript applications from scratch for Atruvia AG's core banking platform, now actively used by 300+ German cooperative banks; frontend integrated with Java/REST backend APIs throughout.
...
- Conducted regular code reviews and drove TypeScript/full-stack best practices in a cross-functional Agile team of 10+.

**stack_line**: Stack: TypeScript, JavaScript, Node.js, RxJS, SCSS, Jenkins, SonarQube, Jest, Cypress.
...
**bullets**:
- Delivered new TypeScript frontend modules for a financial instruments management platform, including complex reactive forms and AG Grid tables handling large financial datasets via REST APIs.
- Led framework version upgrades and contributed to full-stack architecture decisions across a team of 10+.
...
**stack_line**: Stack: TypeScript, JavaScript, Node.js, AG Grid, REST API, SCSS.
...
**stack_line**: Stack: TypeScript, JavaScript, Node.js, SCSS, Bootstrap.
