...
CASES = [
    ...
    ("242 540–302 840 CAD/yr", (242540.0, 302840.0, "CAD", "year", "", 20211.67, 25236.67)),
    ("120 000 AUD per year", (120000.0, 120000.0, "AUD", "year", "", 10000.0, 10000.0)),
    ("55 000 SEK/month", (55000.0, 55000.0, "SEK", "month", "", 55000.0, 55000.0)),
    ("80 000 - 100 000 CZK", (80000.0, 100000.0, "CZK", "month", "", 80000.0, 100000.0)),
