...
- Invented **client prestige**: "Fortune 500 clients", "top-tier clients",
  ...
  appears in the job posting. See the Candidate Ground Truth section above for
  the candidate's real employers/clients; anything grander than what's
  documented there or in the profile is fabricated.
...
- Invented **metrics or scale**: percentages, user counts, revenue, team sizes,
  ...
  team/org sizes, counts, percentages, years of experience — are allowed and
  must be preserved exactly as stated there.)
...
in a bullet — e.g. "Built 3 apps with NGXS at Acme Corp" where NGXS is not in
the profile.
...
- **Preserve the profile's real numbers and clients** — never flag any real
  employer/client named in the Candidate Ground Truth section above, or any
  metric (years of experience, team/org size, counts, percentages) that
